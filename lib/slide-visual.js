...
// A caixa da marca costuma ser o corpo do slide inteiro. A faixa de cima fica
// com o texto — título, planta, área, período — e o resto é do desenho.
...
export function areaDoVisual(retangulo, slide) {
  ...
  const tituloH = Math.min(r.altura * FATIA_TITULO, pol(TITULO_MAX));
