...
// `curto` e o que cabe no seletor ao lado dos indicadores; `rotulo` e o nome
// por extenso, para onde houver espaco de explicar.
export const UNIDADES = [
  { valor: 'min', rotulo: 'minutos',             curto: 'min' },
  { valor: 'h',   rotulo: 'horas',               curto: 'horas' },
  { valor: 'm',   rotulo: 'metros de tecelagem', curto: 'metros' },
  { valor: 'um',  rotulo: 'UM do material',      curto: 'UM' },
];
...
export const sufixoUnidade = (unidade, porDiaUtil = false) =>
  (unidade === 'm' ? 'm' : unidade === 'um' ? 'un'
   : eMinuto(unidade) ? 'min' : 'h')
  // Sem isto, capacidade do mês e capacidade por dia útil apareceriam com o
  // mesmo rótulo, e a segunda é dez a vinte vezes menor que a primeira.
  + (porDiaUtil ? '/dia útil' : '');
