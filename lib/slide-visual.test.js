...
test('o grupo vira uma marca por bloco, e não uma por linha', () => {
  // Quatro linhas de "cadastros" seguidas são UMA marca: uma por linha viraria
  // uma escada de réguas que não marca bloco nenhum.
  const x = xml();
