...
export async function recursosCadastro() {
  return sql`
    select r.id, r.codigo, r.nome, r.tipo_recurso,
           ...
           -- `ativo` é o que o componente de cadastro lê para pintar a linha
           -- em cinza e oferecer Reativar. Recurso sem parâmetro conta como
           -- ativo: o problema dele é outro, e a tela já avisa em separado.
