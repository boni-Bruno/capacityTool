...
export const ORIGENS = ['META', 'REAL', 'PROJETADO'];
...
/**
 * O motor escolhe o OEE por vigência e turno, SEM filtrar origem
 * (03_motor.sql). Duas origens cobrindo a mesma data são aceitas pelo exclude
 * constraint, mas o `limit 1` de lá pega uma delas sem critério — o número do
 * cálculo passa a depender de sorte.
 *
 * A tela avisa quando isso acontece em vez de deixar passar calado.
 */
