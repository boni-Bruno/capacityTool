...
/**
 * Fecha a vigência que está valendo e abre uma nova a partir de `aPartirDe`.
 *
 ...
 */
export async function abrirVigencia(tabela, chave, aPartirDe, valores) {
  ...
  const plano = planejar(linhas, data, t.rotulo);
  ...
  passos.push(t.inserir(chave, data, valores));
