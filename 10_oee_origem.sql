...
begin
    ...
    -- OEE da origem pedida. Prefere o específico do turno; senão o geral do
    -- recurso. Sem OEE cadastrado naquela origem, coalesce usa 100% — a
    -- disponível sai igual à planejada, e a tela avisa quando isso acontece.
    left join lateral (
